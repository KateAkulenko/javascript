...
console.log("Результат віднімання:", result.numerator + "/" + result.denominator);
...
console.log("Результат віднімання:", integer + " " + result.numeratorNew + "/" + result.denominator);
...
console.log("Результат віднімання:", integer + " " + result.numeratorNewShot + "/" + result.denominator);
}
...
console.log("Результат множення:", result.numerator + "/" + result.denominator);
...
console.log("Результат множення:", integer + " " + result.numeratorNew + "/" + result.denominator);
...
console.log("Результат множення:", integer + " " + result.numeratorNewShot + "/" + result.denominator);
}
...
console.log("Результат ділення:", result.numerator + "/" + result.denominator);
...
console.log("Результат ділення:", integer + " " + result.numeratorNew + "/" + result.denominator);
...
console.log("Результат ділення:", integer + " " + result.numeratorNewShot + "/" + result.denominator);
}
