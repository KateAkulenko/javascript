...
const number1 = parseInt(prompt("Введіть перше число що б знайти спільний дільник: "));
const number2 = parseInt(prompt("Введіть друге число що б знайти спільний дільник: "));
let gcd = 0;
...
let dividers = 0;
let str = '';
for (let i = 1; i <= a; i++) { // посинаємо шукати дільники з 1 і +1 що б перевірити кожен, зупиниться коли буде рівне вказаному числу
    if (a % i === 0) { // відбираємо ті дільники які не залишають остачі
    dividers = i;
